...
// ────────────────────────────────────────────────────────────
// _HourglassDemo — sand timer with Start / Pause / Reset
// ────────────────────────────────────────────────────────────
class _HourglassDemo extends StatefulWidget {
  const _HourglassDemo();

  @override
  State<_HourglassDemo> createState() => _HourglassDemoState();
}

class _HourglassDemoState extends State<_HourglassDemo> {
  ...
  // Wall-clock tracking for the countdown display.
  DateTime? _startedAt;
  ...
  @override
  Widget build(BuildContext context) {
    return _TimerRefresh(enabled: _running, builder: _buildContent);
  }
...
// Rebuilds its subtree every second to keep the countdown accurate.
class _TimerRefresh extends StatefulWidget {
  const _TimerRefresh({required this.enabled, required this.builder});
  ...
  @override
  State<_TimerRefresh> createState() => _TimerRefreshState();
}

class _TimerRefreshState extends State<_TimerRefresh>
  ...
  @override
  void didUpdateWidget(covariant _TimerRefresh oldWidget) {
...
// ────────────────────────────────────────────────────────────
// _HourglassBtn — icon + label pill button
// ────────────────────────────────────────────────────────────
class _HourglassBtn extends StatelessWidget {
  const _HourglassBtn({
    required this.icon,
    required this.label,
    required this.color,
